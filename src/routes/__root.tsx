...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "منظومة متكاملة لإدارة بلاغات صيانة مباني ومرافق جمعية الجبيل، متابعة التسعير والميزانيات." },
      { name: "author", content: "HQ Jubail" },
      { property: "og:title", content: "بوابة إدارة وصيانة أصول جمعية الجبيل" },
      { property: "og:description", content: "منظومة متكاملة لإدارة بلاغات الصيانة وتسعيرها ومتابعة الميزانيات." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Readex+Pro:wght@300;400;500;600;700&family=Cairo:wght@400;600;700&display=swap",
      },
    ],
  }),
