...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "منظومة رقمية فاخرة لإدارة بلاغات الصيانة والتسعير والميزانيات." },
    ],
  }),
  component: Landing,
});
      ...
      <main className="mx-auto max-w-7xl px-6 pt-16 pb-24">
        ...
        <section className="mt-20">
          <div className="glass-panel p-10 text-center">
            ...
            <p className="mt-3 text-muted-foreground">أنشئ حسابك واختر دورك للدخول إلى لوحة التحكم المخصصة.</p>
            <div className="mt-6">
              <Link to="/auth" className="btn-gold">إنشاء حساب / تسجيل الدخول</Link>
            </div>
          </div>
        </section>
      </main>
